...
to avoid it. Most of the time, after visiting it and checking all those shiny
projects and remarkable articles that people create, after a few moments of
...
somehow I ended up there again last night (I was venting out some rant on
Medium ~~comments~~ responses system and one of the top hits was HN).
...
transfer (which is still better than my grasp of NLP). However, the article is
...
![Sample Image](/images/dall-e-capybara-example.png)
_Examples of DALL-E output for prompt shown above, all credit goes to Open AI_

I mean, come on! That is impressive. Yet again, similar to the introduction
...
Some clever points were made there which might give us humans some
hope for the near future. Here are those which appealed to me most:
...
list some highlights about _DALL-E_ so it doesn't seem that I am a bitter man
...
- Added [hypothes.is](https://web.hypothes.is/) sidebar to the site. Found it
  accidentally during my Medium ~~comments~~ responses rage. Seems like very
  neat concept and decided to give it a try.
- Read a little about SSR (why we circled back) and web performance. Checked
